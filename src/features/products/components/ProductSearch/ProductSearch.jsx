  ...
  return (
    ...
    <div className="products-filters">
      <label>
        ...
        <GlassSelect value={filters.categoryId} onChange={(event) => onFilter("categoryId", event.target.value)}>
      ...
      <label>
        <span>Brend</span>
        <GlassSelect value={filters.brandId} onChange={(event) => onFilter("brandId", event.target.value)}>
          <option value="all">Barchasi</option>
          {brands.map((item) => (
            <option key={item.id} value={item.id}>{item.name}</option>
          ))}
      ...
      <label>
        <span>Qoldiq</span>
        <GlassSelect value={filters.stockStatus} onChange={(event) => onFilter("stockStatus", event.target.value)}>
          <option value="all">Barchasi</option>
      ...
      <label>
        ...
        <GlassSelect value={filters.warehouse} onChange={(event) => onFilter("warehouse", event.target.value)}>
          <option value="all">Barchasi</option>
          {warehouses.map((item) => (
            <option key={item.id} value={item.id}>{item.name}</option>
          ))}
    ...
    <details className="products-advanced-filters">
      ...
      <div className="products-filters">
        <label>
          <span>Tasdiq</span>
          <GlassSelect value={filters.approvalStatus} onChange={(event) => onFilter("approvalStatus", event.target.value)}>
            <option value="all">Barchasi</option>
            <option value="draft">Qoralama</option>
            <option value="pending">Tasdiq kutilmoqda</option>
        ...
        <label>
          ...
          <GlassSelect value={filters.missingData} onChange={(event) => onFilter("missingData", event.target.value)}>
            <option value="all">Barchasi</option>
